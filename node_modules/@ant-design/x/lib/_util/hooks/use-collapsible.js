...
const useCollapsible = (collapsible, prefixCls, rootPrefixCls) => {
  ...
  // ============================ ExpandedKeys ============================
  const [mergedExpandedKeys, setMergedExpandedKeys] = (0, _util.useControlledState)(defaultExpandedKeys || [], isThoughtChainUnControlled ? undefined : customizeExpandedKeys);
