...
const DividerBubble = ({
  ...
  const rootMergedCls = (0, _clsx.clsx)(hashId, cssVarCls, prefixCls, `${prefixCls}-divider`, contextConfig.className, contextConfig.classNames.root, className, classNames.root, rootClassName);
  const dividerContentRender = content => {
    return /*#__PURE__*/_react.default.createElement(_antd.Divider, dividerProps, content);
  };
...
const ForwardDividerBubble = /*#__PURE__*/_react.default.forwardRef(DividerBubble);
if (process.env.NODE_ENV !== 'production') {
  ForwardDividerBubble.displayName = 'DividerBubble';
}
var _default = exports.default = ForwardDividerBubble;