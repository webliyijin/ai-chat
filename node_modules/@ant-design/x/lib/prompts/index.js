...
const ForwardPrompts = /*#__PURE__*/_react.default.forwardRef((props, ref) => {
  const {
  ...
  const mergedListCls = (0, _clsx.clsx)(`${prefixCls}-list`, contextConfig.classNames.list, classNames.list, {
  ...
  const motionName = fadeInLeft || fadeIn ? `${rootPrefixCls}-x-fade${fadeInLeft ? '-left' : ''}` : '';
  ...
  return /*#__PURE__*/_react.default.createElement(_motion.default, {
    ...
    return /*#__PURE__*/_react.default.createElement("div", (0, _extends2.default)({}, htmlProps, {
      ...
      className: (0, _clsx.clsx)(mergedCls, motionClassName),
      style: {
        ...style,
        ...contextConfig.style,
        ...styles.root
      ...
      level: 5,
      className: (0, _clsx.clsx)(`${prefixCls}-title`, contextConfig.classNames.title, classNames.title),
      style: {
      ...
      return /*#__PURE__*/_react.default.createElement("div", {
        ...
        className: (0, _clsx.clsx)(`${prefixCls}-item`, contextConfig.classNames.item, classNames.item, {
        ...
        className: (0, _clsx.clsx)(`${prefixCls}-content`, contextConfig.classNames.itemContent, classNames.itemContent),
        style: {
