...
const Welcome = /*#__PURE__*/_react.default.forwardRef((props, ref) => {
  const {
  ...
  const iconNode = _react.default.useMemo(() => {
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
      className: (0, _clsx.clsx)(`${prefixCls}-icon`, contextConfig.classNames.icon, classNames.icon),
      style: styles.icon
    }, iconEle);
  }, [icon]);
  ...
  const extraNode = _react.default.useMemo(() => {
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
      className: (0, _clsx.clsx)(`${prefixCls}-extra`, contextConfig.classNames.extra, classNames.extra),
      style: styles.extra
    }, extra);
  }, [extra]);
  ...
  return /*#__PURE__*/_react.default.createElement(_antd.Flex, {
    ref: ref,
    className: (0, _clsx.clsx)(prefixCls, contextConfig.className, className, rootClassName, classNames.root, hashId, cssVarCls, `${prefixCls}-${variant}`, {
    ...
    className: (0, _clsx.clsx)(`${prefixCls}-description`, contextConfig.classNames.description, classNames.description),
