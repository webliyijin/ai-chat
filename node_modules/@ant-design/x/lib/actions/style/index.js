  ...
  return {
    [componentCls]: {
      ...
      [`${componentCls}-variant-outlined`]: {
        paddingInline: (0, _cssinjs.unit)(calc(token.paddingXXS).add(1).equal()),
...
var _default = exports.default = (0, _genStyleUtils.genStyleHooks)('Actions', token => {
  ...
  return [genActionsStyle(compToken), (0, _copy.default)(compToken), (0, _feedback.default)(compToken), (0, _audio.default)(compToken), (0, _style.initFadeLeftMotion)(compToken), (0, _style.initFadeMotion)(compToken)];
