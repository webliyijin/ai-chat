...
var _default = exports.default = (0, _genStyleUtils.genStyleHooks)('Sources', token => {
  const SourcesToken = (0, _cssinjsUtils.mergeToken)(token, {});
  return [genSourcesStyle(SourcesToken), (0, _style.genCollapseMotion)(SourcesToken)];
